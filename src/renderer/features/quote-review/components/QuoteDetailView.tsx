...
import { ArrowLeft, Check, Trash2, Edit2, BookOpen, Search, AlertTriangle } from 'lucide-react';
 ...
 * Shows reference editor and all actions. Text and interjections are edited in the main editor.
 */
  ...
  return (
    <div className="quote-detail-view">
        ...
        {quote.isNonBiblical ? (
          ...
          <div className="quote-detail-reference-editor">
            ...
            <div className="quote-detail-edit-actions">
              <button className="quote-btn-secondary" onClick={() => setIsEditingReference(false)}>
                Cancel
              </button>
              <button className="quote-btn-primary" onClick={handleReferenceSubmit}>
                Save
              </button>
            </div>
          </div>
          ...
          <div className="quote-detail-reference-display">
            ...
            <span
              className={
                quote.reference ? 'quote-detail-reference-text' : 'quote-detail-reference-missing'
              }
            >
      ...
      <div className="quote-detail-section">
        ...
        <div className="quote-detail-interjection-info">
          {quote.interjections && quote.interjections.length > 0 ? (
            <p className="quote-detail-info-text">
              {quote.interjections.length} interjection{quote.interjections.length > 1 ? 's' : ''}{' '}
              detected. Adjust boundaries in the editor or side panel.
            </p>
          ) : (
            <p className="quote-detail-info-text">No interjections detected</p>
          )}
        </div>
      </div>
      ...
      <div className="quote-detail-main-actions">
        ...
        {/* Delete Button */}
        <button className="delete-btn-large" onClick={onDelete} title="Delete Quote">
          <Trash2 size={18} />
        </button>
      </div>
    </div>
